...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function isBulletPoint(line) {
        ...
        return BULLET_PATTERNS.some(function (pattern) { return pattern.test(trimmedLine); });
    }
    // Helper function to remove bullet point markers
    function removeBulletPoint(line) {
        var trimmedLine = line.trim();
        for (var _i = 0, BULLET_PATTERNS_1 = BULLET_PATTERNS; _i < BULLET_PATTERNS_1.length; _i++) {
            var pattern = BULLET_PATTERNS_1[_i];
    ...
    function cleanItemContent(content) {
        ...
        for (var _i = 0, _a = Object.entries(entityMap); _i < _a.length; _i++) {
    ...
    function cleanWordContentToListItems(content) {
        ...
        if (content.includes('<li>') || content.includes('<LI>')) {
            var liMatches = content.match(/<li[^>]*>(.*?)<\/li>/gi);
            if (liMatches) {
                items = liMatches.map(function (li) {
                    var itemContent = li.replace(/<li[^>]*>|<\/li>/gi, '').trim();
            ...
            for (var _i = 0, lines_1 = lines; _i < lines_1.length; _i++) {
                ...
                if (isBulletPoint(line)) {
                    var itemContent = removeBulletPoint(line);
                    var cleaned = cleanItemContent(itemContent);
                    if (cleaned.trim().length > 0) {
                        items.push(cleaned);
                    }
                }
                else if (line.trim().length > 0) {
                    var cleaned = cleanItemContent(line);
                    if (cleaned.trim().length > 0) {
                        items.push(cleaned);
                    }
                }
    ...
    return __generator(this, function (_a) {
        ...
        Commands.add("paste-from-word", {
            run: function (editor) {
                ...
                var modalContent = "\n                <div>\n                    <p id=\"paste-from-word-text\">".concat(opts.t9n.labelPasteFromWordText, "</p>\n                    <textarea id=\"paste-from-word-content\" placeholder=\"").concat(opts.t9n.labelPasteFromWordPlaceholder, "\"></textarea>\n                    <div id=\"paste-from-word-footer\">\n                        <button id=\"paste-from-word-apply\">").concat(opts.t9n.labelPasteFromWordButton, "</button>\n                    </div>\n                </div>\n            ");
                modal.setTitle(opts.t9n.labelPasteFromWord);
                modal.setContent(modalContent);
                modal.open();
                setTimeout(function () {
                    var textarea = document.getElementById('paste-from-word-content');
                    var applyBtn = document.getElementById('paste-from-word-apply');
                    if (textarea) {
                        textarea.focus();
                    }
                    if (applyBtn) {
                        applyBtn.addEventListener('click', function () {
                            if (textarea && selected) {
                                ...
                                var listItems = cleanWordContentToListItems(content);
                                selected.components().reset();
                                selected.addAttributes({
                                    'class': 'ulist fa-ul',
                                    'style': 'padding: 0.2rem 0; margin-left: 2em; line-height: 1.4em;'
                                });
                                listItems.forEach(function (itemContent) {
                                    var liHtml = "<li class=\"ulistitem\" style=\"text-align: left;\"><span class=\"fa-li\" style=\"left: -2em; width: 2em;\"><i class=\"fas fa-circle\" style=\"font-size: 0.4em; line-height: inherit; display: block;\"></i></span><p style=\"margin: 0; padding: 0; text-align: left;\">".concat(itemContent, "</p></li>");
        ...
        function showOstToolbar(listItem) {
            ...
            if (ostToolbar != undefined) {
                ...
                cBtn.addEventListener("click", function () {
                    ...
                    if (!listItem || !editor)
                        return;
                    var clonedItem = listItem === null || listItem === void 0 ? void 0 : listItem.clone();
                ...
                if (elPos != elLast) {
                    ...
                    dwnBtn.addEventListener("click", function () {
                        if (toPos_1 && (listItem === null || listItem === void 0 ? void 0 : listItem.parent()) != undefined) {
                            var parent_2 = listItem.parent();
                            if (parent_2) {
                                listItem.move(parent_2, { at: toPos_1 });
                            }
                            editor.selectRemove(listItem);
                            editor.select(listItem);
                        }
