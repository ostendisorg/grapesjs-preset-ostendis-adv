            ...
            if (ostToolbar != undefined) {
                ...
                cBtn.addEventListener("click", function () {
                    ...
                    if (!listItem || !editor)
                        return;
                    // Get style
                    var origId = listItem.getId();
                    var rule = editor.CssComposer.getRule("#".concat(origId));
                    var origStyle = (rule === null || rule === void 0 ? void 0 : rule.getStyle()) || {};
                    var copiedStyle = JSON.parse(JSON.stringify(origStyle));
                    var clonedItem = listItem.clone();
                    (_a = listItem.parent()) === null || _a === void 0 ? void 0 : _a.append(clonedItem, { at: elPos + 1 });
                    var cloneId = clonedItem.getId();
                    // Set style
                    editor.CssComposer.addRules([
                        {
                            selectors: ["#".concat(cloneId)],
                            style: copiedStyle,
                        },
                    ]);
                    // -----------------------------------------------------------------------
