...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(editor, opts) {
    ...
    Blocks.add("divider", {
        ...
        media: "<svg style=\"width:48px\" viewBox=\"0 0 12.7 9.525\" xmlns=\"http://www.w3.org/2000/svg\">\n        <path d=\"m-1.4833e-5 4.5835h12.7v0.35797h-12.7z\" stroke-width=\"2\"/>\n      </svg>",
    });
    ...
    Blocks.add("titleAndText", {
        ...
        content: {
            ...
            components: [
                {
                    type: "text",
                    content: "<h3>".concat(opts.t9n.titleAndTextBlkContentTitle, "</h3>"),
                },
                {
                    type: "text",
                    content: "<p>Text</p>",
    ...
    Blocks.add("titleAndList", {
        ...
        content: {
            ...
            components: [
                {
                    type: "text",
                    content: "<h3>".concat(opts.t9n.titleAndListBlkContentTitle, "</h3>"),
                },
                {
                    type: "ulist",
                },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    var cmdOpenImport = opts.cmdOpenImport;
    var openExport = "export-template";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, juiceOpts: {}, usedOstBlocks: [], cmdOpenImport: "gjs-open-import-template", cmdInlineHtml: "gjs-get-inlined-html", codeViewerTheme: "hopscotch", inlineCss: true, updateStyleManager: true, showStylesOnChange: true, showBlocksOnLoad: false, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
