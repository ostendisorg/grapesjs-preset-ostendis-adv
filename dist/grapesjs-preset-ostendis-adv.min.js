(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["grapesjs-preset-ostendis-adv"] = factory();
	else
		root["grapesjs-preset-ostendis-adv"] = factory();
...
var cheerio = __webpack_require__(/*! ./lib/cheerio */ "./node_modules/juice/lib/cheerio.js");
var makeJuiceClient = __webpack_require__(/*! ./lib/inline */ "./node_modules/juice/lib/inline.js");
...
var utils = __webpack_require__(/*! ./utils */ "./node_modules/juice/lib/utils.js");
...
var utils = __webpack_require__(/*! ./utils */ "./node_modules/juice/lib/utils.js");
var numbers = __webpack_require__(/*! ./numbers */ "./node_modules/juice/lib/numbers.js");
...
var parser = __webpack_require__(/*! slick/parser */ "./node_modules/slick/parser.js");
...
var mensch = __webpack_require__(/*! mensch */ "./node_modules/mensch/index.js");
var Selector = __webpack_require__(/*! ./selector */ "./node_modules/juice/lib/selector.js");
var Property = __webpack_require__(/*! ./property */ "./node_modules/juice/lib/property.js");
...
module.exports = {
    ...
    parse: __webpack_require__(/*! ./lib/parser */ "./node_modules/mensch/lib/parser.js"),
    stringify: __webpack_require__(/*! ./lib/stringify */ "./node_modules/mensch/lib/stringify.js")
};
...
var debug = __webpack_require__(/*! ./debug */ "./node_modules/mensch/lib/debug.js")('lex');
...
var debug = __webpack_require__(/*! ./debug */ "./node_modules/mensch/lib/debug.js")('parse');
var lex = __webpack_require__(/*! ./lexer */ "./node_modules/mensch/lib/lexer.js");
...
var debug = __webpack_require__(/*! ./debug */ "./node_modules/mensch/lib/debug.js")('stringify');
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(editor, opts) {
    ...
    Blocks.add("applyButton", {
        ...
        content: "<a data-gjs-type=\"link\" href=\"$$$ApplyLink$$$\" target=\"_blank\" role=\"button\" style=\"" +
            btnStyle +
            "\">".concat(opts.t9n.buttonApplyBlkText, "</a>"),
...
/* harmony import */ var _openExportCommand__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./openExportCommand */ "./src/openExportCommand.ts");
/* harmony import */ var _openImportCommand__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./openImportCommand */ "./src/openImportCommand.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    DomComponents.addType("video", {
        model: dModel.extend({
            updateTraits: function () {
                ...
                this.set({ tagName: tagName }, { silent: 1 }); // avoid break in view
    ...
    DomComponents.addType("ulist", {
        ...
        model: {
            defaults: {
                ...
                traits: ["id", (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeTextTrait)(opts), (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeHideInSimpleHtmlTrait)(opts)],
            },
        },
    });
    // Header component
    DomComponents.addType("header", {
        ...
        model: {
            defaults: {
                tagName: "h1", //Default
                traits: ["id", (0,_consts__WEBPACK_IMPORTED_MODULE_0__.headerTrait)(opts), (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeTextTrait)(opts), (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeHideInSimpleHtmlTrait)(opts)],
            },
        }
    });
    // Icon component
    DomComponents.addType("icon", {
        isComponent: function (el) {
            ...
            if (el.tagName === "I" && classNames.some(function (className) { return el.classList.contains(className); })) {
                return { type: "icon" };
            }
        },
        model: {
    ...
    DomComponents.addType("link", {
        model: {
            defaults: {
                traits: ["id", "href", "target", (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeTextTrait)(opts), (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeHideInSimpleHtmlTrait)(opts)],
            },
        },
    });
    ...
    DomComponents.addType("image", {
        model: {
            defaults: {
                traits: ["alt", (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeImageTrait)(opts), (0,_consts__WEBPACK_IMPORTED_MODULE_0__.ostTypeHideInSimpleHtmlTrait)(opts)],
            },
        },
    });
...
/* harmony export */   headerTrait: () => (/* binding */ headerTrait),
...
var ulListItem = "<li style=\"text-align:left\" data-gjs-type=\"ulistitem\">" + uListItemContent + "</li>";
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    cmdm.add(opts.cmdInlineHtml, {
        run: function (editor, s, opts) {
            if (opts === void 0) { opts = {}; }
            var tmpl = editor.getHtml() + "<style>".concat(editor.getCss(), "</style>");
    ...
    cmdm.add(opts.cmdOpenExport, {
        ...
        createCodeEditor: function () {
            ...
            var codeEditor = this.createCodeViewer();
            el.style.flex = "1 0 auto";
            el.style.boxSizing = "border-box";
            el.className = "".concat(pfx, "export-code");
            el.appendChild(codeEditor.getElement());
            return { codeEditor: codeEditor, el: el };
        },
        getCodeContainer: function () {
            var containerEl = this.containerEl;
            if (!containerEl) {
                containerEl = document.createElement("div");
                containerEl.className = "".concat(pfx, "export-container");
        ...
        run: function (editor) {
            var codeEditorHtml = this.codeEditorHtml;
            var container = this.getCodeContainer();
            // Init code viewer if not yet instantiated
            if (!codeEditorHtml) {
                var codeViewer = this.createCodeEditor();
                codeEditorHtml = codeViewer.codeEditor;
                this.codeEditorHtml = codeEditorHtml;
                if (opts.t9n.modalLabelExport) {
                    var labelEl = document.createElement("div");
                    labelEl.className = "".concat(pfx, "export-label");
            ...
            if (codeEditorHtml) {
                var tmpl = "".concat(editor.getHtml(), "<style>").concat(editor.getCss(), "</style>");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    cmdm.add(opts.cmdOpenImport, {
        ...
        createCodeEditor: function () {
            ...
            el.style.flex = "1 0 auto";
            el.style.boxSizing = "border-box";
            el.className = "".concat(pfx, "import-code");
            el.appendChild(codeEditor.getElement());
            return { codeEditor: codeEditor, el: el };
        },
        getCodeContainer: function () {
            ...
            if (!containerEl) {
                containerEl = document.createElement("div");
                containerEl.className = "".concat(pfx, "import-container");
                containerEl.style.display = "flex";
                containerEl.style.gap = "5px";
                containerEl.style.flexDirection = "column";
                containerEl.style.justifyContent = "space-between";
        ...
        run: function (editor) {
            ...
            // Init code viewer if not yet instantiated
            if (!codeEditorHtml) {
                var codeViewer_1 = this.createCodeEditor();
                var btnImp = document.createElement("button");
                codeEditorHtml = codeViewer_1.codeEditor;
                this.codeEditorHtml = codeEditorHtml;
                ...
                btnImp.onclick = function () {
                    var code = codeViewer_1.codeEditor.editor.getValue();
                    editor.Components.clear();
                    editor.Css.clear();
                    editor.setComponents(code);
                    editor.Modal.close();
                };
                container.appendChild(codeViewer_1.el);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    var cmdOpenImport = opts.cmdOpenImport, cmdOpenExport = opts.cmdOpenExport;
    var openStyleManager = "open-sm";
    var openTraits = "open-tm";
    var openLayers = "open-layers";
    var openBlocks = "open-blocks";
    var activateOutline = "sw-visibility";
    var iconStyle = 'style="display: block; max-width: 22px"';
        ...
        },
        {
            ...
            buttons: [
                ...
                },
                {
                    ...
                    label: "<svg ".concat(iconStyle, " viewBox=\"0 0 24 24\">\n              <path fill=\"currentColor\" d=\"M12.89,3L14.85,3.4L11.11,21L9.15,20.6L12.89,3M19.59,12L16,8.41V5.58L22.42,12L16,18.41V15.58L19.59,12M1.58,12L8,5.58V8.41L4.41,12L8,15.58V18.41L1.58,12Z\" />\n          </svg>"),
                },
                {
                    id: cmdOpenImport,
    ...
    editor.onReady(function () {
        ...
        if (opts.showBlocksOnLoad) {
            var btn = Panels.getButton("views", openBlocks);
            btn === null || btn === void 0 ? void 0 : btn.set("active", true);
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) {
    ...
    TraitManager.addType("ost-blocks-select", {
        createInput: function (_a) {
            ...
            var options = traitOpts.length ? traitOpts : [{ id: "", name: "None", disabled: "disabled" }];
            var el = document.createElement("div");
            el.innerHTML = "\n        <select class=\"ost-blocks-select\" id=\"".concat(traitName, "\">\n          ").concat(options.map(function (opt) { return "<option value=\"".concat(opt.id, "\" ").concat(opt.disabled, ">").concat(opt.name, "</option>"); }).join(""), "\n        </select>\n        <div class=\"gjs-sel-arrow\">\n          <div class=\"gjs-d-s-arrow\"></div>\n        </div>");
            return el;
        },
        onEvent: function (_a) {
            var _b;
...
var plugin = function (editor_1) {
    ...
    return __awaiter(void 0, __spreadArray([editor_1], args_1, true), void 0, function (editor, opts) {
        ...
        var config, options, titles, i, el, title;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = editor.getConfig();
                    options = __assign({ blocks: [], block: function () { return ({}); }, juiceOpts: {}, usedOstBlocks: [], cmdOpenExport: "gjs-open-export-template", cmdOpenImport: "gjs-open-import-template", cmdInlineHtml: "gjs-get-inlined-html", codeViewerTheme: "hopscotch", inlineCss: true, updateStyleManager: true, showStylesOnChange: true, showBlocksOnLoad: false, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
                ...
                case 1:
                    _a.sent();
                    titles = document.querySelectorAll("*[data-tooltip-pos]");
                        ...
                        if (selected != undefined) {
                            ...
                            if (selected.is("ulistitem")) {
                                ...
                                if (selected.components().length == 0) {
                                    ...
                                    var newComponent = (_b = selected.parent()) === null || _b === void 0 ? void 0 : _b.append("<li>Text</li>", { at: selectedPosition });
                                    selected.remove();
...
//# sourceMappingURL=grapesjs-preset-ostendis-adv.min.js.map