...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        RichTextEditor.add('removeFormat', {
            ...
            result: function (rte) { rte.exec('removeFormat'); }
        });
        return [2 /*return*/];
    });
}); });
...
var plugin = function (editor_1) {
    ...
    return __awaiter(void 0, __spreadArray([editor_1], args_1, true), void 0, function (editor, opts) {
        ...
        return __generator(this, function (_a) {
            ...
            (0,_rte__WEBPACK_IMPORTED_MODULE_5__["default"])(editor, options);
            ...
            editor.on("load", function () {
                ...
                var changeHeaderType = function (component) {
                    ...
                    if (tagName && headings.includes(tagName.toLowerCase()) && component.get('type') === 'text') {
                        ...
                        component.setTraits([{ name: 'id' }, (0,_consts__WEBPACK_IMPORTED_MODULE_7__.headerTrait)(options), (0,_consts__WEBPACK_IMPORTED_MODULE_7__.ostTypeTextTrait)(options), (0,_consts__WEBPACK_IMPORTED_MODULE_7__.ostTypeHideInSimpleHtmlTrait)(options)]);
                    }
