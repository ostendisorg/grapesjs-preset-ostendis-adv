        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, usedOstBlocks: [], cmdOpenExport: "gjs-open-export-template", cmdOpenImport: "gjs-open-import-template", codeViewerTheme: "hopscotch", inlineCss: false, updateStyleManager: true, showStylesOnChange: true, showBlocksOnLoad: false, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
